                            ...
                            <ul class="list-unstyled m-t-15 notifications">
                                <li>
                                    <a href="" class="message icon-not striped-col">
                                        <img class="message-image img-circle"
                                                src="{{asset('assets/img/authors/avatar3.jpg')}}" alt="avatar-image">
                                ...
                                <li>
                                    <a href="" class="message icon-not">
                                        <img class="message-image img-circle"
                                                src="{{asset('assets/img/authors/avatar.jpg')}}" alt="avatar-image">
                                        <div class="message-body">
                                            <strong>Tony</strong>
                                            <br>
                                ...
                                <li>
                                    <a href="" class="message icon-not striped-col">
                                        <img class="message-image img-circle"
                                                src="{{asset('assets/img/authors/avatar6.jpg')}}" alt="avatar-image">
                                ...
                                <li>
                                    <a href="" class="message icon-not">
                                        <img class="message-image img-circle"
                                                src="{{asset('assets/img/authors/avatar1.jpg')}}" alt="avatar-image">
                                        <div class="message-body">
                                ...
                                <li>
                                    <a href="" class="message icon-not striped-col">
                                        <img class="message-image img-circle"
                                                src="{{asset('assets/img/authors/avatar7.jpg')}}" alt="avatar-image">
